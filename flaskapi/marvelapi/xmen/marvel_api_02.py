...
fnameURL = 'https://gateway.marvel.com:443/v1/public/creators?'
...
def authorfnamecall(timestamp, hashyhash, pkey, fname):
    r = requests.get(fnameURL + 'firstName=' + fname + '&apikey' + pkey)
...
def main():           
    ...
    ## display results
    #print(uncannyxmen)
    fnamelookup = authorfnamecall(pkey, args.fname)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fname', \
      help='First name of a comic book author')
